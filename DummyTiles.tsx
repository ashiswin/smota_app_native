  ...
  Daily: [
    {
      ...
      background: require('./assets/images/7_readings.png'),
      description: undefined,
    },
    {
    ...
    },
    {
      ...
      isLink: true,
      target: '',
      background: require('./assets/images/9_saintoftheday.png'),
      description: undefined,
    },
    {
      title: 'Rosary',
      isLink: true,
      target: '',
      background: require('./assets/images/10_rosary.png'),
      description: undefined,
    },
    {
      title: 'Divine Mercy',
      isLink: true,
      target: '',
      background: require('./assets/images/11_divinemercy.png'),
      description: undefined,
    },
  ],
  Grow: [
